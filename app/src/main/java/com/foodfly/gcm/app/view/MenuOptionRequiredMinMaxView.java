 ...
 */
public class MenuOptionRequiredMinMaxView extends LinearLayout implements IMenuOptionView, OnClickListener {
    ...
    public MenuOptionRequiredMinMaxView(Context context) {
        super(context);
        initialize();
    }
    ...
    public void setOption(MenuOption menuOption) {
        ...
        mType.setText(String.format(Locale.getDefault(), "(필수, %d개 이상 %d개 까지)", menuOption.getMin(), menuOption.getMax()));
