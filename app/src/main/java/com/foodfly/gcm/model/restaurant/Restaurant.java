...
public class Restaurant extends RealmObject {
    ...
    @Ignore
    private boolean mServiceArea = true;
    @Ignore
    private String mConnectAreaOpenHour;
    ...
    public long[] getAvailableDeliveryHour() {
        ...
        long start = AppClock.currentTimeMillis();
    ...
    public String getConnectAreaOpenHour() {
        return mConnectAreaOpenHour;
    }

    public void setConnectAreaOpenHour(String connectAreaOpenHour) {
        mConnectAreaOpenHour = connectAreaOpenHour;
    }
}